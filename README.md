...
A curated list of [SurrealDB](https://github.com/surrealdb/surrealdb) ⭐ 32,949 | 🐛 743 | 🌐 Rust | 📅 2026-08-21 resources, tools, utilities, and applications.
...
* [surrealdb.py](https://github.com/surrealdb/surrealdb.py) ⭐ 268 | 🐛 3 | 🌐 Python | 📅 2026-08-24 - <a href="https://surrealdb.com#gh-dark-mode-only" target="_blank"><img src="/img/white/text.svg" height="12" alt="SurrealDB"></a> <a href="https://surrealdb.com#gh-light-mode-only" target="_blank"><img src="/img/black/text.svg" height="12" alt="SurrealDB"></a> official driver for Python.
* [surrealdb.net](https://github.com/surrealdb/surrealdb.net) ⭐ 138 | 🐛 30 | 🌐 C# | 📅 2026-07-29 - <a href="https://surrealdb.com#gh-dark-mode-only" target="_blank"><img src="/img/white/text.svg" height="12" alt="SurrealDB"></a> <a href="https://surrealdb.com#gh-light-mode-only" target="_blank"><img src="/img/black/text.svg" height="12" alt="SurrealDB"></a> official driver for .NET.
...
* [Surrealist](https://github.com/surrealdb/surrealist) ⭐ 1,298 | 🐛 53 | 🌐 TypeScript | 📅 2026-08-10 - <a href="https://surrealdb.com#gh-dark-mode-only" target="_blank"><img src="/img/white/text.svg" height="12" alt="SurrealDB"></a> <a href="https://surrealdb.com#gh-light-mode-only" target="_blank"><img src="/img/black/text.svg" height="12" alt="SurrealDB"></a> official dashboard, query playground and database explorer for SurrealDB.
...
* [open-notebook](https://github.com/lfnovo/open-notebook) ⭐ 37,758 | 🐛 141 | 🌐 TypeScript | 📅 2026-08-16 - An Open Source implementation of Notebook LM with more flexibility and features.
* [Podcasts to Knowledge](https://github.com/cocoindex-io/cocoindex/tree/v1/examples/conversation_to_knowledge) ⭐ 11,420 | 🐛 73 | 🌐 Rust | 📅 2026-08-27 - Converts YouTube podcast/interview sessions into a structured knowledge graph with CocoIndex.
