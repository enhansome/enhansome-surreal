...
A curated list of [SurrealDB](https://github.com/surrealdb/surrealdb) ⭐ 32,882 | 🐛 742 | 🌐 Rust | 📅 2026-07-06 resources, tools, utilities, and applications.
...
* [open-notebook](https://github.com/lfnovo/open-notebook) ⭐ 36,754 | 🐛 128 | 🌐 TypeScript | 📅 2026-08-11 - An Open Source implementation of Notebook LM with more flexibility and features.
* [Podcasts to Knowledge](https://github.com/cocoindex-io/cocoindex/tree/v1/examples/conversation_to_knowledge) ⭐ 11,289 | 🐛 72 | 🌐 Rust | 📅 2026-08-12 - Converts YouTube podcast/interview sessions into a structured knowledge graph with CocoIndex.
